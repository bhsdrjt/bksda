...
jQuery( document ).ready( function( $ ) {
    ...
    $table1.DataTable( {
        ...
        "fnDrawCallback": function () {
            ...
            var v_id_resort = this.id;
            var v_url = "<?php echo base_url() ?>app/resortedit";
            
                $.ajax({
                    type: 'POST',
                    url: v_url,
                    data: {
                        id_resort: v_id_resort
                    },
                    beforeSend: function () {
                    },
            ...
            $.confirm({
                ...
                buttons: {
                    hapus: {
                        ...
                        action: function(){
                            window.location.assign("<?php echo base_url() ?>app/resorthapus?id="+v_id);
                        }
                    },
                    batal: function () {
