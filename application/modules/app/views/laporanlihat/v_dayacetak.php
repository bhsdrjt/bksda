		...
		<div class="invoice">
			...
			<div class="row">
				...
				<table width="100%" style="margin:30px">
					...
					<tr> 
						<td width="30%">Nama Kelompok</td><td> : <?php echo $data['data1']; ?></td>
					</tr>
					<tr> 
						<td width="30%">SK Kelompok</td><td> : <?php echo $data['data2']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Lokasi</td><td> : <?php echo $data['data3']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Jenis Usaha</td><td> : <?php echo $data['data4']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Jumlah Anggota</td><td> : <?php echo $data['data5']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Kegiatan-kegiatan</td><td> : <?php echo $data['data6']; ?></td>
					</tr>
					<tr> 
