<ol class="breadcrumb bc-3">
	<li>
		<a href="<?php echo base_url() ?>app">
			<i class="fa fa-map-marker"></i>Pemberdayaan Masyarakat</a>
	</li>
	<li class="active">
		<strong>Lihat Laporan Pemberdayaan Masyarakat</strong>
	</li>
</ol>

<h3>Data Detil Laporan Pemberdayaan Masyarakat</h3>
		...
		<?php pesan_get('msg',"Berhasil Memvalidasi Laporan","Berhasil Menolak Validasi laporan") ?>
			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="form-group row">
						<label class="col-lg-4 control-label">Nama Kelompok</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data1']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">SK Kelompok</label>
						<div class="col-lg-8">
					...
					<div class="form-group row">
						<label class="col-lg-4 control-label">Jenis Usaha </label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data4']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Jumlah Anggota</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data5']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Kegiatan-kegiatan</label>
						<div class="col-lg-8">
