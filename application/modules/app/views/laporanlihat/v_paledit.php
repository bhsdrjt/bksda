<ol class="breadcrumb bc-3">
    ...
    <li class="active">
        <strong> PAL Batas Wilayah</strong>
    </li>
</ol>

<h3>Edit Laporan PAL Batas Wilayah</h3>
	...
	<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>app/laporanedit"	method="post"  enctype="multipart/form-data" id="form"> 	
		<div class="row">
			<div class="col-md-12">
                ...
                <input type="hidden" name="kategori" value="PAL Batas Wilayah">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label">Nomor PAL Batas *</label>
                    <div class="col-lg-6">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label">Kondisi PAL *</label>
					<div class="col-lg-6">
                        <select class="form-control" name="data2" id="data2" >
                            <option value="" disabled selected>.:Pilih Kondisi PAL:.</option>
							<option value="Baik" <?php echo $data['data2']=="Baik"?"selected":""; ?>>Baik</option>
							<option value="Rusak" <?php echo $data['data2']=="Rusak"?"selected":""; ?>>Rusak</option>
                            <option value="Bergeser" <?php echo $data['data2']=="Bergeser"?"selected":""; ?>>Bergeser</option>
							<option value="Hilang"  <?php echo $data['data2']=="Hilang"?"selected":""; ?>>Hilang</option>
                            <option value="Lainnya"  <?php echo $data['data2']=="Lainnya"?"selected":""; ?>>Lainnya</option>
                            </select>
					</div>
				</div>
                <div class="form-group">
					<label class="col-lg-3 control-label">Material PAL *</label>
					<div class="col-lg-6">
                        <select class="form-control" name="data3" id="data3" >
                            <option value="" disabled selected>.:Pilih Material PAL:.</option>
							<option value="Beton" <?php echo $data['data3']=="Beton"?"selected":""; ?>>Beton</option>
							<option value="kayu" <?php echo $data['data3']=="kayu"?"selected":""; ?>>kayu</option>
                            <option value="Batas Alam" <?php echo $data['data3']=="Batas Alam"?"selected":""; ?>>Batas Alam</option>
