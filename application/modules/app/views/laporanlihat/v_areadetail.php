<ol class="breadcrumb bc-3">
	<li>
		<a href="<?php echo base_url() ?>app">
			<i class="fa fa-map-marker"></i>Area Terbuka/Open Area</a>
	</li>
	<li class="active">
		<strong>Lihat Laporan Area Terbuka/Open Area</strong>
	</li>
</ol>

<h3>Data Detil Laporan Area Terbuka/Open Area</h3>
		...
		<?php pesan_get('msg',"Berhasil Memvalidasi Laporan","Berhasil Menolak Validasi laporan") ?>
			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="form-group row">
						<label class="col-lg-4 control-label">Luas Wilayah Terbuka</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data1']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Indikasi Penyebab</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data2']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Jenis Open Area</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data3']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Tingkat Kerusakan</label>
						<div class="col-lg-8">
