<ol class="breadcrumb bc-3">
	<li>
		<a href="<?php echo base_url() ?>app">
			<i class="fa fa-map-marker"></i>Satwa Liar</a>
	</li>
	<li class="active">
		<strong>Lihat Laporan Satwa Liar</strong>
	</li>
</ol>

<h3>Data Detil Laporan Satwa Liar</h3>
		...
		<?php pesan_get('msg',"Berhasil Memvalidasi Laporan","Berhasil Menolak Validasi laporan") ?>
			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="form-group row">
						<label class="col-lg-4 control-label">Spesies / Nama Latin</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data1']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Nama Lokal</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data3']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Jumlah Perjumpaan</label>
						<div class="col-lg-8">
					...
					<div class="form-group row">
						<label class="col-lg-4 control-label">Endemisitas</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data5']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Status Perlindungan</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data6']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Status IUCN </label>
						<div class="col-lg-8">
