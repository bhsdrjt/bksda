<ol class="breadcrumb bc-3">
	<li>
		<a href="<?php echo base_url() ?>app">
			<i class="fa fa-map-marker"></i>PAL Batas Wilayah</a>
	</li>
	<li class="active">
		<strong>Lihat Laporan PAL Batas Wilayah</strong>
	</li>
</ol>

<h3>Data Detil Laporan PAL Batas Wilayah</h3>
		...
		<?php pesan_get('msg',"Berhasil Memvalidasi Laporan","Berhasil Menolak Validasi laporan") ?>
			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="form-group row">
						<label class="col-lg-4 control-label">Nomor PAL Batas</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data1']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Kondisi PAL</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data2']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Material PAL</label>
						<div class="col-lg-8">
