		...
		<div class="invoice">
			...
			<div class="row">
				...
				<table width="100%" style="margin:30px">
					...
					<tr> 
						<td width="30%">Nama Desa / Dusun</td><td> : <?php echo $data['data1']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Nama Kepala Desa / Dusun</td><td> : <?php echo $data['data2']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Kontak Person<</td><td> : <?php echo $data['data3']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Jumlah Penduduk</td><td> : <?php echo $data['data4']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Jumlah Kepala Keluarga</td><td> : <?php echo $data['data5']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Mayoritas pekerjaan</td><td> : <?php echo $data['data6']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Keterangan Sejarah Desa</td><td> : <?php echo $data['data7']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Keterangan Sejarah Desa</td><td> : <?php echo $data['data2']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Keterangan Interaksi Masyarakat terhadap kawasan</td><td> : <?php echo $data['data8']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Keterangan Lainnya</td><td> : <?php echo $data['keterangan']; ?></td>
					</tr>
					<tr> 
