		...
		<div class="invoice">
			...
			<div class="row">
				...
				<table width="100%" style="margin:30px">
					...
					<tr> 
						<td width="30%">Luas Wilayah Terbuka</td><td> : <?php echo $data['data1']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Indikasi Penyebab</td><td> : <?php echo $data['data2']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Jenis Open Area</td><td> : <?php echo $data['data3']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Tingkat Kerusakan</td><td> : <?php echo $data['data4']; ?></td>
					</tr>
					<tr> 
