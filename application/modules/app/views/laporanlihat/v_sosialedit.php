...
<h3>Edit Laporan Sosial Ekonomi</h3>
			...
			<div class="col-md-12">
				...
				<div class="form-group">
					...
					<select class="form-control" name="data6" id="data6" >
							...
							<option value="Petani/Pekebun"  <?php echo $data['data6']=="Petani/Pekebun"?"selected":""; ?>>Petani/Pekebun</option>
							<option value="Nelayan" <?php echo $data['data6']=="Nelayan"?"selected":""; ?>>Nelayan</option>
							<option value="Buruh" <?php echo $data['data6']=="Buruh"?"selected":""; ?>>Buruh</option>
							<option value="Swasta" <?php echo $data['data6']=="Swasta"?"selected":""; ?>>Swasta</option>
							<option value="Lainnya" <?php echo $data['data6']=="Lainnya"?"selected":""; ?>>Lainnya</option>
						</select>
                    </div>
                </div>

				<div class="form-group">
					<label class="col-lg-3 control-label">Keterangan Sejarah Desaa</label>
                    <div class="col-lg-6">
						<textarea class="form-control" name="data7" id="data7"><?php echo $data['data7']; ?><</textarea>
                    </div>
                </div>
				<div class="form-group">
					<label class="col-lg-3 control-label">Keterangan Interaksi Masyarakat terhadap kawasan</label>
                    <div class="col-lg-6">
						<textarea class="form-control" name="data8" id="data8"><?php echo $data['data8']; ?><</textarea>
                    </div>
                </div>
                <div class="form-group">
