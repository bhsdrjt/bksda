		...
		<div class="invoice">
			...
			<div class="row">
				...
				<table width="100%" style="margin:30px">
					...
					<tr> 
						<td width="30%">Spesies / Nama Latin</td><td> : <?php echo $data['data1']; ?></td>
					</tr>
				
					<tr> 
						<td width="30%">Nama Lokal</td><td> : <?php echo $data['data3']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Jumlah Perjumpaan</td><td> : <?php echo $data['data8']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Kelas Satwa</td><td> : <?php echo $data['data4']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Endemisitas</td><td> : <?php echo $data['data5']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Status Perlindungan</td><td> : <?php echo $data['data6']; ?></td>
					</tr>
					<tr> 
						<td width="30%">Status IUCN</td><td> : <?php echo $data['data7']; ?></td>
					</tr>
					<tr> 
