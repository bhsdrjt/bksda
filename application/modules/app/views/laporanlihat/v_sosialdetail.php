<ol class="breadcrumb bc-3">
	<li>
		<a href="<?php echo base_url() ?>app">
			<i class="fa fa-map-marker"></i>Sosial Ekonomi</a>
	</li>
	<li class="active">
		<strong>Lihat Laporan Sosial Ekonomi</strong>
	</li>
</ol>

<h3>Data Detil Laporan Sosial Ekonomi</h3>
		...
		<?php pesan_get('msg',"Berhasil Memvalidasi Laporan","Berhasil Menolak Validasi laporan") ?>
			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="form-group row">
						<label class="col-lg-4 control-label">Nama Desa / Dusun</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data1']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Nama Kepala Desa / Dusun</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data2']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Kontak Person</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data3']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Jumlah Penduduk</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data4']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Jumlah Kepala Keluarga</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data5']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Mayoritas pekerjaan</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data6']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Keterangan Sejarah Desa</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data7']; ?> </p>
						</div>
					</div>
					<div class="form-group row">
						<label class="col-lg-4 control-label">Keterangan Interaksi Masyarakat terhadap kawasan</label>
						<div class="col-lg-8">
							<p  class="form-control-static" > : <?php echo $data['data8']; ?> </p>
						</div>
					</div>
					
					<div class="form-group row">
						<label class="col-lg-4 control-label">Keterangan Lainnya</label>
						<div class="col-lg-8">
