<ol class="breadcrumb bc-3">
	<li>
		<a href="<?php echo base_url() ?>app">
			<i class="fa fa-map-marker"></i>Wisata Alam</a>
	</li>
	<li class="active">
		<strong>Lihat Laporan Wisata Alam</strong>
	</li>
</ol>

<h3>Data Detil Laporan Wisata Alam</h3>
		...
		<?php pesan_get('msg',"Berhasil Memvalidasi Laporan","Berhasil Menolak Validasi laporan") ?>
			...
			<div class="row">
				<div class="col-md-5">
					...
					<div class="form-group row">
						<label class="col-lg-4 control-label">Nama Lokasi Wisata</label>
						<div class="col-lg-8">
