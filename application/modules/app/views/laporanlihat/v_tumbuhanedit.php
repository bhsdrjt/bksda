	...
	<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>app/laporanedit"	method="post"  enctype="multipart/form-data" id="form"> 	
		<div class="row">
			<div class="col-md-12">
                ...
                <input type="hidden" name="kategori" value="Tumbuhan">
				...
				<div class="form-group">
					<label class="col-lg-3 control-label">Jenis Tumbuhan *</label>
					<div class="col-lg-6">
                        <select class="form-control" name="data4" id="data4" >
                            <option value="" disabled selected>.:Pilih Kelas:.</option>
							<option value="Pohon" <?php echo $data['data4']=="Pohon"?"selected":""; ?>>Pohon</option>
							<option value="Non Pohon" <?php echo $data['data4']=="Non Pohon"?"selected":""; ?>>Non Pohon</option>
						</select>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-lg-6">
                        <select class="form-control" name="data5" id="data5" >
							...
							<option value="Dilindungi" <?php echo $data['data5']=="Dilindungi"?"selected":""; ?>>Dilindungi</option>
     					    <option value="Tidak Dilindungi" <?php echo $data['data5']=="Tidak Dilindungi"?"selected":""; ?>>Tidak Dilindungi</option>
						</select>
					</div>
				</div>
                <div class="form-group">
