...
<h3>Input Laporan Wisata Alam</h3>
...
<div class="panel-body">
	...
	<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>app/inputwisata"	method="post"  enctype="multipart/form-data" id="form"> 	
		<div class="row">
			<div class="col-md-12">
			    <input type="hidden" name="<?=$csrf['name']?>" value="<?=$csrf['hash']?>">
                <input type="hidden" name="kategori" value="Wisata Alam">
                ...
                <div class="form-group">
                    <label class="col-lg-3 control-label">Nama Lokasi Wisata *</label>
                    <div class="col-lg-6">
