...
<h3>Input Laporan PAL Batas Wilayah</h3>
...
<div class="panel-body">
	...
	<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>app/inputpal"	method="post"  enctype="multipart/form-data" id="form"> 	
		<div class="row">
			<div class="col-md-12">
				...
				<div class="form-group">
					...
					<div class="col-lg-6">
                        <select class="form-control" name="data2" id="data2" >
                            ...
                            <option value="Bergeser">Bergeser</option>
                ...
                <div class="form-group">
					...
					<div class="col-lg-6">
                        <select class="form-control" name="data3" id="data3" >
                            ...
                            <option value="Batas Alam">Batas Alam</option>
							<option value="Lainnya" >Lainnya</option>
                            </select>
					</div>
				</div>
