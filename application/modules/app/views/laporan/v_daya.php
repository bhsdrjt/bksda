<ol class="breadcrumb bc-3">
    ...
    <li>
        <a href="<?php echo base_url() ?>app/inputdayaa">
...
<h3>Input Laporan Pemberdayaan Masyarakat</h3>
...
<div class="panel-body">
	...
	<form role="form" class="form-horizontal validate"  action="<?php echo base_url() ?>app/inputdaya"	method="post"  enctype="multipart/form-data" id="form"> 	
		<div class="row">
			<div class="col-md-12">
