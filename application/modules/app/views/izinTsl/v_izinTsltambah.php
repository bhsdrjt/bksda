...
<div class="panel panel-primary" data-collapsed="0">
    ...
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal validate" action="<?php echo base_url() ?>app/izinTsltambah" method="post" enctype="multipart/form-data" id="form" onsubmit="validateForm(event)">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <select class="form-control" name="jenis" id="jenis" onchange="loadpemilik()">
                                ...
                                <option value="lembaga konservasi">Lembaga Konservasi</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <div class="input-group" style="width: 100%;">
                                <input type="text" class="form-control datepicker error-message" data-format="dd-mm-yyyy" value="" name="waktu_pendataan" style="background-color:#fff" placeholder="" id="waktu_pendataan" data-mask="date" aria-invalid="true">
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <input type="text" id="jumlah" name="jumlah" class="form-control angka" onkeypress="return inputAngka(event)">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-8">
                            <textarea style="height: 100px;" class="form-control" id="keterangan" name="keterangan"></textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function loadpemilik() {
        let jenis = $("#jenis").val();
        $.ajax({
            url: "<?php echo base_url() ?>app/getPemilik", // Ganti dengan URL endpoint yang sesuai
            method: "GET",
            data: {
                jenis: jenis
            },
