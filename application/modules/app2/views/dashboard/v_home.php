...
<div class="row">
			<div class="col-sm-3 col-xs-12">
				...
				<div class="tile-stats tile-primary">
					...
					<div class="num" data-start="0" data-end="<?php echo $jumlahlaporan ?>" data-postfix="" data-duration="500" data-delay="0">0</div>
			...
			<div class="col-sm-3 col-xs-12">
				...
				<div class="tile-stats tile-white">
					...
					<div class="num" data-start="0" data-end="<?php echo $jumlahlaporanmenunggu ?>" data-postfix="" data-duration="500" data-delay="0">0</div>
			...
			<div class="col-sm-3 col-xs-12">
				...
				<div class="tile-stats tile-green">
					...
					<div class="num" data-start="0" data-end="<?php echo $jumlahlaporanvalid ?>" data-postfix="" data-duration="500" data-delay="0">0</div>
		
					<h3>Laporan Tervalidasi</h3>
					<p>Situation Room.</p>
					</div>
			</div>
			...
			<div class="col-sm-3 col-xs-12">
				<div class="tile-stats tile-red">
					...
					<div class="num" data-start="0" data-end="<?php echo $jumlahlaporantolak ?>" data-postfix="" data-duration="500" data-delay="0">0</div>

					<h3>Laporan Tertolak</h3>
					<p>Situation Room.</p>
				</div>
			</div>
		</div>
	...
	<div class="col-sm-6">
		...
		<div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title">Jumlah Laporan Sesuai Kategori</div>
        ...
        <div class="panel panel-primary">
			<div class="panel-heading">
				<div class="panel-title">Jumlah Laporan Per Kawasan</div>
			...
			<table class="table table-bordered table-responsive" style="font-size:11px">
				...
				<?php
				$i = 1;
					foreach($laporankawasan->result_array() as $row){
						echo "
							<tr><td>".$i++."</td>
