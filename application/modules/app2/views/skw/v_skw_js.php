...
jQuery( document ).ready( function( $ ) {
    ...
    $table1.DataTable( {
        ...
        "fnDrawCallback": function () {
            ...
            var v_id_skw = this.id;
            var v_url = "<?php echo base_url() ?>app/skwedit";
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        $('#form2').validate({ // initialize plugin
                            ...
                            messages: {
                                namawilayah: {
                                    required: "Nama SKW Tidak boleh kosong"
                                },
                                lintang: {
            ...
            $.confirm({
                ...
                buttons: {
                    hapus: {
                        ...
                        action: function(){
                            window.location.assign("<?php echo base_url() ?>app/skwhapus?id="+v_id);
                        }
                    },
                    batal: function () {
