		...
		<div class="row">
			<div class="col-md-12">
                ...
                <div class="form-group">
					...
					<div class="form-group">
					<label class="col-lg-3 control-label">Jenis Gangguan *</label>
					<div class="col-lg-6">
                        <select class="form-control" name="data1" id="data1" >
                            <option value="" disabled selected>.:Pilih Kelas:.</option>
							<option value="Perambahan / Ilegal Logging" <?php echo $data['data1']=="Perambahan / Ilegal Logging"?"selected":""; ?>>Perambahan / Ilegal Logging</option>
							<option value="Pembukaan Lahan" <?php echo $data['data1']=="Pembukaan Lahan"?"selected":""; ?>>Pembukaan Lahan</option>
							<option value="Perburuan" <?php echo $data['data1']=="Perburuan"?"selected":""; ?>>Perburuan</option>
							<option value="Lainnya" <?php echo $data['data1']=="PLainnya"?"selected":""; ?>>Lainnya</option>
						</select>
					</div>
				</div>
